...
*	HTTP (s?) (the protocol that drives the Web) communicates via input/output just like the terminal.
...
* If you don't see version 4 or higher returned, raise your hand
...
Final project proposal - Due Lesson 8
