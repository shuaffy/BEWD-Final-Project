...
#intern only gets first name / last name as a full_name

class MarketingIntern < Marketer
  attr_accessor :paid

  def initialize first_name, last_name, twitter_handle, paid
    super(first_name, last_name, "intern", twitter_handle)    #marketing intern will always have title "intern or something"
    @paid = paid
  end
